        ...
        <div className="container mx-auto  w-full p-0 lg:w-1/2">
          <TypeCart title="Những gì chúng tôi cung cấp:" imgSrc="/logo1.png">
            <ul className="mb-4 list-disc pl-5">
              <li className="list-disc font-medium text-red-500  ">
                <span className="text-gray-800">
                  <span className="font-semibold">Yamaha MT07</span> 
                  là một chiếc xe máy có khả năng vận hành cực kỳ năng động, cho phép bạn di chuyển mượt mà và an toàn trên đường. Ngoài ra, đặc điểm thiết kế và xử lý của nó làm cho nó trở thành một chiếc xe máy dễ lái và có thể tùy chỉnh.
                </span>
              </li>
              <li className="list-disc font-medium text-red-500  ">
                <span className="text-gray-800">
