    ...
    <div className="cartOfert">
      <div className="p-8 sm:p-10 lg:flex-auto">
        <h3 className="text-2xl font-bold tracking-tight text-gray-900">
          Hạng bằng A4, A1, A2, A3
        </h3>
        <p className="mt-6 text-base leading-7 text-gray-600">
        Có được sự tự do và độc lập của bạn với khóa học lái xe loại A của chúng tôi! Dưới con mắt thận trọng của những người hướng dẫn giàu kinh nghiệm, bạn sẽ học cách lái xe an toàn và tự tin, đạt được các kỹ năng cần thiết sẽ mở ra những cơ hội mới cho bạn. 
