  ...
  return (
    <div className="cartOfert">
      <div className="p-8 sm:p-10 lg:flex-auto">
        ...
        Có được sự tự do và độc lập của bạn với khóa học lái xe loại D của chúng tôi! Dưới con mắt thận trọng của những người hướng dẫn giàu kinh nghiệm, bạn sẽ học cách lái xe an toàn và tự tin, đạt được các kỹ năng cần thiết sẽ mở ra những cơ hội mới cho bạn. 
